    ...
    return Padding(
      ...
      child: Card(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(color: context.watch<ThemeNotifier>().darkTheme?Colors.black:Colors.white,
            ...
            child: SizedBox(
              ...
              child: Column(
               ...
               //here listviewbuilder height is not taken by expanded view as widget nested one above another
                ...
                Text(prouctItem.name, style: TextStyle(
                color:   context.watch<ThemeNotifier>().darkTheme?Colors.white:Colors.black,
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                                         decoration: BoxDecoration(color: context.watch<ThemeNotifier>().darkTheme?const Color.fromARGB(255, 60, 57, 57):Color.fromARGB(255, 177, 144, 144),
                                         borderRadius: BorderRadius.circular(10)
                           ...
                           child: Padding(
                            ...
                            //  color: context.watch<ThemeNotifier>().darkTheme?Colors.black:Colors.white,
